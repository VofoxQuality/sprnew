...
//	}
	...
	public void TCSPR0901008() {
		...
		softAssert1.assertEquals(getText(ba.ddcoursename2), CourseName.trim(),
	...
	public void TCSPR0901010() {
		...
		Assert.assertEquals(getText(ps.studantname2_gridval).trim(), "Ben Alex");
	...
	public void TCSPR0901012() {
		...
		waitThread(4000);
		// Assert the Assessment Open time should be 2 min buffer time as default
		// datefrom the current time
		Assert.assertTrue(getValue(sb.assessmentopentime_txtbx).contains(sb.getTime(2)));

		// Assert the Assessment Due date should be 7 days buffer time as default date
	...
	public void TCSPR0901013() {
		...
		// Assert that the Peer Review Open time is same time as the test close time
		Assert.assertEquals(getValue(sb.peerreviewopentime_txtbx), assessmentopentime);
	...
	public void TCSPR0901016() {
		...
		// Assert.assertEquals(getAttribute(sb.schedule_wizard, "aria-selected"),
		// "true");
	...
	public void TCSPR0901018() {
		...
		// Assert the Allow students to raise a Reconsideration Request Label visible
		Assert.assertEquals(getText(sb.allowstudent_lbl), "Allow students to raise a Reconsideration Request");

		// Assert the Allow students to raise a Reconsideration Request check box is
		// unchecked
	...
	public void TCSPR0901019() {
		...
		Scroll_DowntoEnd();
		waitThread(3000);
		Assert.assertTrue(isElementPresent(sb.mailnotifi_checkbx), "checkbox is present");
		...
		//Assert.assertFalse(isEnabled(sb.mailnotifi_checkbx2), "radio button is selected");
	...
	public void TCSPR0901021() {
		...
		// Assert the Teacher will manually publish the result check box is selected
		Assert.assertTrue(isEnabled(sb.teachwill_radio_select),
				"Teacher will manually publish the result radio button not selected");

		// Assert the Mail Notification and When a new assessment is published check box
		// is selected
		Assert.assertTrue(isEnabled(sb.mailnotifi_checkbx), "mail notification checkbox not selected");
		Assert.assertTrue(isEnabled(sb.Wnewassess_checkbx), "When a new assessment is published checkbox not selected");
	}
	...
	/*
	 * To verify the validation messages on the schedule page
		-To fill Test window due date and time
	 */
	@Test(priority = 27)
	public void TCSPR0901027() {
		...
		Assert.assertTrue(isElementPresent(sb.assessdue_calendar), "Calendar not  present");
	...
	public void TCSPR0901028() {	
		...
		// Assert the calendar visible
		Assert.assertTrue(isElementPresent(sb.peeropen_calendar), "Calendar not  present");
		...
		// Assert the calendar visible
		Assert.assertTrue(isElementPresent(sb.peerdue_calendar), "Calendar not  present");
	...
	/*
	 * To check the validation messages for the assessment open date section
	 * To fill  the details on the schedule page for Test open date/Allow students 
	...
	public void TCSPR0901030() {	
		...
		Assert.assertTrue(isElementPresent(sb.assessopen_calendar), "Calendar not  present");
		...
		Assert.assertFalse(isElementPresent(sb.assessopen_calendar), "Calendar not  present");
	...
	/*
	 * To check the validation messages for the assessment open date section
	 * To fill  the details on the schedule page for Test open date and notifications is mandatory
	 */
	@Test(priority = 31)
	public void TCSPR0901031() {	
		...
		// Assert toaster"Select at least one mail notification"
		Assert.assertEquals(getText(QP.toaster),"Select at least one mail notification");
	...
	/*
	 * To fill the Test window open date and time,peer review open and Due date and time 
	 */
	@Test(priority = 32)
	...
	/*
	 * To verify the valiation messages[for Test due date] 
	 * when click on save and next andsave and exit buttons
	 */
	@Test(priority = 34)
	...
	/*
	 * To fill the Test window open/due date and time,peer review Due date 
	 * and time ,Result publishing date and time
	 */
	@Test(priority = 35)
	...
	/*
	 * To verify the valiation messages[for Peer review open date]
	 *  when click on save and next andsave and exit buttons	
	 */
	@Test(priority = 36)
	...
	public void TCSPR0901037() {
		...
		click(sb.assessmentduedate_txtbx);
		waitThread(1000);
		Assert.assertTrue(isElementPresent(sb.assessdue_calendar), "Calendar  present");
	...
	/*
	 * To verify the valiation messages[for Peer review Due date] 
	 * when click on save and next andsave and exit buttons
	 */
	@Test(priority = 38)
	...
	/*
	 * To fill the Test window open/due date and time,peer review open/due date and time
	 */
	@Test(priority = 39)
	...
	/*
	 * To verify the valiation messages[for Result publishing date]
	 *  when click on save and next andsave and exit buttons
	 */
	@Test(priority = 40)
	...
	public void TCSPR0901041() {
		...
		// Assert calendar visible
		Assert.assertTrue(isElementPresent(sb.resultpublish_calendar), "Calendar not  present");
	...
	/*
	 * To verify the Open/Due date and time of Test window when selecting current date
	 * -To verify the Test Window Open and Due time having 1 min Difference
	 */
	@Test(priority = 42)
	public void TCSPR0901042() {
		...
		Assert.assertEquals(sb.geTtimedifferenceminute(sb.assessmentopentime_txtbx, sb.assessmentduetime_txtbx), "01");	
		
	}
	/*
	 * To verify the Open/Due date and time of Peer review  window when selecting current date
	 * --To verify the Peer review Open/Due time having 1 min Difference
	 */
	@Test(priority = 43)
	public void TCSPR0901043() {
		...
		// Assert the Peer review Open time and Due time having 01 min difference
		Assert.assertEquals(sb.geTtimedifferenceminute(sb.peerreviewopentime_txtbx, sb.peerreviewduetime_txtbx), "01");
